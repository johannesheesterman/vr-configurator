<!doctype html><html><head><title>three-mesh-ui | examples</title><meta charset="utf-8"><meta name="viewport" content="width=device-width,user-scalable=no,minimum-scale=1,maximum-scale=1"><style>:root {
		...
		* {
		...
		}</style></head><body><div id="page"><div id="menu"><div id="navbar-container"><button id="toggle-btn" onclick="toggleNavbar()">more examples ▼</button></div><div id="examples-container"><h1>three-mesh-ui</h1><a id="github-link-menu" href="https://github.com/felixmariotto/three-mesh-ui" target="_blank"><img id="menu-icon" src="https://felixmariotto.s3.eu-west-3.amazonaws.com/github-white-icon.png"> Github page</a><h2>examples</h2><ul><li title="basic_setup">basic setup</li><li title="preloaded_font">preloaded font</li><li title="nested_blocks">nested blocks</li><li title="border">block borders</li><li title="tutorial_result">tutorial result</li><li title="interactive_button">interactive button</li><li title="msdf_text">big text</li><li title="background_size">backgroundSize</li><li title="inline_block">InlineBlock</li><li title="hidden_overflow">hiddenOverflow</li><li title="onafterupdate">onAfterUpdate</li><li title="manual_positioning">manual content positioning</li><li title="keyboard">keyboard</li><li title="letter_spacing">letter spacing</li></ul></div></div><div id="iframe-container"><iframe src="./basic_setup.html" allowfullscreen allowvr frameborder="0"></iframe><img src="https://felixmariotto.s3.eu-west-3.amazonaws.com/loading-three-mesh-ui.gif"> <a id="github-link" href="" target="_blank"><img id="example-code-icon" src="https://felixmariotto.s3.eu-west-3.amazonaws.com/github-white-icon.png"> code on Github</a></div></div><script>const root = document.documentElement;
